...
export default function DatabaseGamePage() {
  ...
  const handlePrevMove = () => setCurrentMoveIndex((prev) => Math.max(-1, prev - 1));
  const handleNextMove = () => setCurrentMoveIndex((prev) => Math.min(history.length - 1, prev + 1));
            ...
            <div className="w-full flex items-center justify-between mb-3 bg-transparent p-1">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/10 rounded overflow-hidden flex items-center justify-center">
                  <img src="/logo-without-text.png" className="w-6 h-6 opacity-50" />
                </div>
            ...
            <div className="w-full flex items-center justify-between mt-3 bg-transparent p-1">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 overflow-hidden rounded bg-white/10">
                  <img 
                    src={game.white.includes("Kasparov") ? "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Garri_Kasparow_%2818776605665%29_%28cropped%29_2.jpg/500px-Garri_Kasparow_%2818776605665%29_%28cropped%29_2.jpg" : "/logo-without-text.png"}
          ...
          <div className="flex border-b border-brand-border">
            ...
            >
              <div className="w-4 h-4 grid grid-cols-2 grid-rows-2 gap-[1px]">
                <div className="bg-current rounded-[1px]" /><div className="bg-transparent border border-current rounded-[1px]" />
                <div className="bg-transparent border border-current rounded-[1px]" /><div className="bg-current rounded-[1px]" />
              </div>
              Moves
            </button>
            <button 
