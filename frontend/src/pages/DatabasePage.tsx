      ...
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-8 h-8 rounded bg-brand-accent/10 flex items-center justify-center border border-brand-accent/20">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="3" y="3" width="8" height="8" fill="var(--gold-bright)"/>
                <rect x="13" y="13" width="8" height="8" fill="var(--gold-bright)"/>
                <rect x="3" y="13" width="8" height="8" fill="var(--glass-border-gold)"/>
                <rect x="13" y="3" width="8" height="8" fill="var(--glass-border-gold)"/>
              </svg>
            </div>
            <h1 className="text-3xl font-semibold font-display tracking-wide text-brand-text">Chess Games Database</h1>
          </div>
                ...
                <div className="p-4 bg-gradient-to-b from-[rgba(255,255,255,0.02)] to-transparent h-[76px] flex flex-col justify-center">
                  {player.active ? (
                    <>
                      ...
                      <p className="text-xs text-brand-secondary mt-1 tracking-wide">{player.games}</p>
                    </>
                  ) : null}
                </div>
              </div>
        ...
        <div className="w-full lg:w-80 flex-shrink-0 flex flex-col items-center gap-6">
          <div className="w-full rounded-xl border border-brand-border bg-brand-surface p-5 shadow-2xl opacity-40 pointer-events-none">
            <h2 className="text-lg font-semibold font-display text-brand-text mb-4">Games</h2>
