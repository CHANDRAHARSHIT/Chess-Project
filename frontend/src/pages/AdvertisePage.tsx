...
import { ArrowLeft, Megaphone, Target, Users, BarChart2, Globe, Zap } from "lucide-react";
...
function AdFormatCard({ title, description, tag, index }: AdFormatCardProps) {
  return (
    ...
    >
      ...
      <h3 className="font-display text-base font-semibold text-brand-text mb-2">{title}</h3>
...
export default function AdvertisePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-brand-bg text-brand-text flex flex-col">
      {/* Hero Banner */}
      <div className="relative overflow-hidden border-b border-brand-border/30">        <div className="max-w-4xl mx-auto px-6 py-16 sm:py-20 relative z-10">
          <button
              type="button"
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <motion.section
          ...
          className="mb-14"
        >
          <h2 className="font-display text-xl font-semibold mb-6 text-brand-text">
            Our Audience
          </h2>
        ...
        <motion.section
          ...
          className="mb-14"
        >
          <h2 className="font-display text-xl font-semibold mb-4 text-brand-text">
