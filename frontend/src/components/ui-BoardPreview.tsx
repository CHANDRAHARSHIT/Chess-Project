...
import type { BoardTheme } from "@/data/appearance-boardThemes";
import type { PieceSetDef } from "@/data/appearance-pieceSets";
...
export default function BoardPreview({ size = 280, theme, pieceSet }: BoardPreviewProps) {
  ...
  return (
    <div
      className="select-none overflow-hidden border border-[rgba(212,175,110,0.60)]"
