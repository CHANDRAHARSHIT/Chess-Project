...
import {
  ...
  getGameOverReason,
  playMoveSound,
} from "@/utils/chess-chessHelpers";
import { generateChess960FEN } from "@/utils/chess-chess960";
...
import { DIFFICULTY_CONFIGS, type DifficultyLevel } from "@/types/chess-chess.types";
...
export default function QuickGameBoard() {
  ...
  useEffect(() => {
    const measure = () => {
      if (boardContainerRef.current) {
        setBoardHeight(
          boardContainerRef.current.getBoundingClientRect().height,
        );
      }
  ...
  */
  ...
  const movePairs: {
    ...
    black: (typeof history)[0] | undefined;
  }[] = [];
  ...
  return (
    <section
      id="interactive-demo"
      className="py-24 md:py-28 relative overflow-hidden bg-brand-bg"
    >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:items-stretch">
            ...
            <div
              ...
              style={{
                height:
                  isDesktop && boardHeight ? `${boardHeight}px` : undefined,
              }}
            >
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <button
                    ...
                    disabled={
                      ...
                      isThinking ||
                      isEditMode ||
                      game_is_human_turn(currentTurn, playerColor) === false
                    }
                    title="Get a hint"
                  ...
                  <button
                    ...
                    style={{
                      cursor:
                        !canUndo || isEditMode ? "not-allowed" : "pointer",
                    }}
                  >
                ...
                >
                  {movePairs.length === 0 ? (
                    ...
                    movePairs.map((pair) => (
                      ...
                      >
                        <span className="col-span-2 text-brand-secondary/70">
                          {pair.moveNumber}.
                        </span>
                        <span className="col-span-5 text-brand-text font-medium">
                          {pair.white.san}
                        </span>
