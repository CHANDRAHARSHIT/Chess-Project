  ...
  const content = (
    <div
      className={`group relative flex flex-col md:flex-row items-center gap-6 p-6 sm:p-7 rounded-3xl backdrop-blur-xl border transition-all duration-300 ${
        isPlayable
          ? 'bg-gradient-to-br from-brand-surface/90 via-brand-surface/70 to-brand-bg/90 border-white/10 hover:border-brand-accent/40 hover:-translate-y-1'
    ...
    >
      ...
      <div className="relative shrink-0 p-2.5 rounded-2xl bg-brand-bg/80 border border-white/5 group-hover:scale-105 group-hover:border-brand-accent/30 transition-all duration-300">
      ...
      <div className="flex-1 text-center md:text-left space-y-3 min-w-0">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
          <span className="px-3 py-1 rounded-full text-[10px] font-mono uppercase tracking-widest font-bold bg-brand-accent/15 text-brand-accent flex items-center gap-1.5">
      ...
      <div className="shrink-0 pt-2 md:pt-0">
        {isPlayable ? (
          <div className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-brand-surface/80 border border-white/10 group-hover:bg-brand-accent group-hover:border-brand-accent text-brand-text group-hover:text-black transition-all duration-300 font-mono text-xs font-bold uppercase tracking-wider">
            <span>Play Now</span>
