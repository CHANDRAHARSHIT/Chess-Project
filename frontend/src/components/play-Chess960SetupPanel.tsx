...
import { type Chess960GameOptions } from '@/hooks/play-useChess960Game';
        ...
        <div className="relative border-b border-brand-text/10 pb-4 sm:pb-5 space-y-3">
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="p-2.5 sm:p-3 rounded-2xl bg-brand-accent/15 text-brand-accent shrink-0">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-2">
            <button
              ref={startBtnRef}
              type="submit"
              className="w-full py-4 px-6 rounded-2xl font-mono text-xs uppercase tracking-widest font-bold btn-premium-cta btn-glow-container btn-glow-accent cta-shine cursor-pointer hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2.5 group"
            >
