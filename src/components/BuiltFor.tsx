  ...
  const targets = [
    {
      ...
      title: 'Chess Coaches',
      description: 'Upgrade from Google Drive folders and messy chat logs. Keep students accountable with structured learning modules.',
      bullets: [
    ...
    },
    {
      ...
      description: 'Stop sending your hard-earned traffic to massive platforms that monetize your audience. Retain community value.',
      bullets: [
    ...
    },
    {
      ...
      description: 'Standardize operations and curriculum across multiple coaches. Maintain oversight on player progression.',
      bullets: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20 space-y-4">
          ...
          <p className="font-sans text-brand-secondary text-base leading-relaxed">
            Whether you are coaching a handful of private students or managing an audience of hundreds of thousands, 
            ChessCraft equips you with enterprise-grade technology.
          </p>
        </div>
