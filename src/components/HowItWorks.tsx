  ...
  const steps = [
    {
      ...
      description: 'Upload your organization logos, configure color palettes matching your academy colors, and connect your custom domain name (e.g. academy.yourname.com).'
    },
    {
      num: '02',
      icon: <Cpu className="w-5 h-5 text-brand-accent" />,
      title: 'Configure Learning Experience',
      description: 'Upload video lectures, create interactive puzzle challenges, compile coordinate practice worksheets, and set up customizable subscriber tier access.'
    },
    {
      num: '03',
      icon: <Rocket className="w-5 h-5 text-brand-accent" />,
      title: 'Launch To Audience',
      description: 'Embed the signup links directly into your streaming descriptions, email newsletters, or website. Instantly invite students to join your owned ecosystem.'
    }
  ];

  return (
    <section id="how-it-works" className="py-20 md:py-28 bg-brand-surface border-b border-brand-border">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Title & Description */}
              <h3 className="font-sans font-bold text-lg text-white pt-2">
                {step.title}
              </h3>
